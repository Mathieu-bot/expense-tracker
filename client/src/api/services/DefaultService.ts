...
export class DefaultService {
   ...
   * @throws ApiError
   */
  public static getExpenses1(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/expenses/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteExpenses(id: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/expenses/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static getIncomes1(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/incomes/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteIncomes(id: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/incomes/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static deleteCategories(id: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/categories/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public static getSummaryMonthly(month?: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/summary/monthly",
      query: {
   ...
   * @throws ApiError
   */
  public static getReceipts(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/receipts/{id}",
      path: {
