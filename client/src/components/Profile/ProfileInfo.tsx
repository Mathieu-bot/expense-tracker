...
const ProfileInfo = ({ user }: { user: UserProfile }) => {
  return (
    <div className="relative min-w-[23vw]">
      <div
        className="bg-gradient-to-br from-primary-light/10 to-primary-dark/10 backdrop-blur-xl rounded-2xl p-8 border border-white/5 shadow-lg h-full 
        ...
        <div className="text-center relative z-10">
          <div className="flex items-start gap-5">
            <div className="relative">
              <div className="-top-16 -left-16 z-10 mx-auto rounded-full flex items-center justify-center mb-6 border-2 border-white/5 shadow-2xl">
                <div className="relative">
