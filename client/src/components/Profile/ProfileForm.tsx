...
export const ProfileForm: React.FC<ProfileFormProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br bg-white/10 dark:from-primary-light/10 dark:to-primary-dark/10 backdrop-blur-xl rounded-3xl p-8 border border-white/15 shadow-2xl transition-all duration-500 hover:shadow-2xl">
