    ...
    <div className="relative" ref={moreActionsRef}>
      ...
      {showMoreActions && (
        <div className="absolute top-full right-0 mt-2 overflow-hidden w-48 bg-white/95 dark:bg-primary-dark/95 backdrop-blur-xl rounded-xl border border-gray-200 dark:border-white/10 z-50 shadow-2xl animate-in fade-in-80">
          <button className="w-full px-4 py-3 border-none hover:bg-gray-100 dark:hover:bg-white/5 transition-all duration-200 flex items-center gap-3 text-left group">
            <div className="w-8 h-8 flex items-center justify-center">
              <ArrowUp className="w-4 h-4 text-gray-600 dark:text-light/70" />
            </div>
